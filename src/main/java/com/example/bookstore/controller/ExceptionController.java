...
public class ExceptionController {
    ...
    public ErrorResponse handleMediaTypeNotAcceptableException(HttpMediaTypeNotAcceptableException ex) {
        return new ErrorResponse("Invalid media type accepted one is " + Constants.VERSION_1_HEADER, null);
    }
    ...
    public ErrorResponse handleException(Exception ex) {
        ...
        return new ErrorResponse("Internal server errors, check server logs", null);
    }
